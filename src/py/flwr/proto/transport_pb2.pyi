...
class ServerMessage(google.protobuf.message.Message):
    ...
    class InitializeConfigIns(google.protobuf.message.Message):
        """ TODO: config sending proto"""
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    INITIALIZE_CONFIG_INS_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def initialize_config_ins(self) -> global___ServerMessage.InitializeConfigIns: ...
    def __init__(self,
        *,
        ...
        initialize_config_ins: typing.Optional[global___ServerMessage.InitializeConfigIns] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["device_info",b"device_info","evaluate_ins",b"evaluate_ins","fit_ins",b"fit_ins","get_parameters",b"get_parameters","initialize_config_ins",b"initialize_config_ins","msg",b"msg","properties_ins",b"properties_ins","reconnect",b"reconnect","sample_latency",b"sample_latency"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["device_info",b"device_info","evaluate_ins",b"evaluate_ins","fit_ins",b"fit_ins","get_parameters",b"get_parameters","initialize_config_ins",b"initialize_config_ins","msg",b"msg","properties_ins",b"properties_ins","reconnect",b"reconnect","sample_latency",b"sample_latency"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["msg",b"msg"]) -> typing.Optional[typing_extensions.Literal["reconnect","get_parameters","fit_ins","evaluate_ins","properties_ins","sample_latency","device_info","initialize_config_ins"]]: ...
...
class ClientMessage(google.protobuf.message.Message):
    ...
    class InitializeConfigRes(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    INITIALIZE_CONFIG_RES_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def initialize_config_res(self) -> global___ClientMessage.InitializeConfigRes: ...
    def __init__(self,
        *,
        ...
        initialize_config_res: typing.Optional[global___ClientMessage.InitializeConfigRes] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["device_info_res",b"device_info_res","disconnect",b"disconnect","evaluate_res",b"evaluate_res","fit_res",b"fit_res","initialize_config_res",b"initialize_config_res","msg",b"msg","parameters_res",b"parameters_res","properties_res",b"properties_res","sample_latency_res",b"sample_latency_res"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["device_info_res",b"device_info_res","disconnect",b"disconnect","evaluate_res",b"evaluate_res","fit_res",b"fit_res","initialize_config_res",b"initialize_config_res","msg",b"msg","parameters_res",b"parameters_res","properties_res",b"properties_res","sample_latency_res",b"sample_latency_res"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["msg",b"msg"]) -> typing.Optional[typing_extensions.Literal["disconnect","parameters_res","fit_res","evaluate_res","properties_res","sample_latency_res","device_info_res","initialize_config_res"]]: ...
